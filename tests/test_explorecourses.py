import unittest
import json
from python_xml_json_explorecourses.python_xml_json_explorecourses import python_xml_parsing
...
class TestExploreCourses(unittest.TestCase):
    ...
    def test_python_xml_parsing(self):
        ...
        result = python_xml_parsing(**params)
        ...
        self.assertListEqual(result['instructors'], ["Emily Levine", "Mitchell Stevens"])
        ...
        self.assertEqual(result['sections'][0]['instructor_name'], "Emily Levine; Mitchell Stevens")
